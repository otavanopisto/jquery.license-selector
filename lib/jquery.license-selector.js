  ...
  $.widget("custom.licenseSelector", {
    ...
    val: function (url) {
      if (url !== undefined) {
        ...
        this.element.hide();
        var typeId = this._resolveType(url);
        ...
        case 'cc':
          $('<div>') 
            ...
            .append(this._createCreativeCommonsList('creative-commons-derivatives', {
              ...
              'no': { label:  this._getText('createCommonsDerivativesYes'), 'attribute': 'nd', 'remove-attributes': 'sa' }, 
    ...
    _name: function () {
      return this.element.attr('id') || (this.element.attr('name') || 'anon') + (++uniqueIdIterator);
    },
